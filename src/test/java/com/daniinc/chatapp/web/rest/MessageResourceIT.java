...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().text(DEFAULT_TEXT).createdAt(DEFAULT_CREATED_AT).mediaUrl(DEFAULT_MEDIA_URL);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT).mediaUrl(UPDATED_MEDIA_URL);
        return message;
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT).mediaUrl(UPDATED_MEDIA_URL);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT).mediaUrl(UPDATED_MEDIA_URL);
